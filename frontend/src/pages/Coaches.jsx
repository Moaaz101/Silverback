...
export default function CoachesPage() {
  ...
  const handleCreateCoach = async (coachData) => {
    try {
      ...
      // Close modal and refresh the coaches list
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center space-x-2 bg-gradient-to-r from-[#492e51] to-[#5a3660] text-xs text-white px-6 py-3 rounded-lg hover:from-[#5a3660] hover:to-[#6b4170] transition-all duration-300 font-medium shadow-lg hover:shadow-xl border border-[#5a3660]/20"
          >
        ...
        {coaches.length === 0 ? (
          <EmptyState 
            ...
            description="There are currently no coaches registered in the system."
          />
        ) : (
        ...
        {/* Stats Summary */}
        <CoachSummaryBox coaches={coaches} />
